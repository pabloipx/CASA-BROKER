...
// Chave Pública (Client ID) - lida de AMPLOPAY_PUBLIC_KEY_V2, com fallback para a fixa.
// Deve formar um PAR VÁLIDO com a chave secreta na mesma conta AmploPay.
// Usamos o sufixo _V2 para ignorar qualquer valor antigo que tenha ficado salvo no ambiente.
const PUBLIC_KEY = process.env.AMPLOPAY_PUBLIC_KEY_V2 || "luzanacostap_z90gs3aj79at13cz"
