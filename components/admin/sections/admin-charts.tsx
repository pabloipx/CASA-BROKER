...
function ChartCard({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute -right-16 -top-16 h-40 w-40 rounded-full bg-[#2563eb]/[0.08] blur-3xl" />
...
const BAR_COLORS = ["#2563eb", "#3b82f6", "#60a5fa", "#60a5fa", "#3b82f6"]
      ...
      <ChartCard title="Atividade da Plataforma" subtitle="Trades e novos usuários · 14 dias" className="lg:col-span-3">
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={data.activitySeries} margin={{ left: -10, right: 8, top: 4 }} barGap={2}>
            ...
            <Tooltip content={<TooltipBox />} cursor={{ fill: "#ffffff08" }} />
            <Bar dataKey="trades" name="Trades" fill="#2563eb" radius={[4, 4, 0, 0]} />
