    ...
    <>
      ...
      >
        <div className="relative">
          ...
          <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 bg-[#2563eb] rounded-full border-2 border-[#0f1419] flex items-center justify-center">
            ...
            <div className="relative p-5 bg-gradient-to-br from-[#1a1f26] via-[#0f1419] to-[#0a0e13] border-b border-white/5">
              <div className="flex items-center gap-4">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#2563eb] rounded-full border-2 border-[#0a0e13] flex items-center justify-center">
                    <div className="w-2 h-2 bg-white rounded-full animate-pulse" />
                  </div>
                </div>
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-[#2563eb] text-xs font-medium flex items-center gap-1.5">
                ...
                <div
                  className={`relative p-5 rounded-2xl border animate-in slide-in-from-bottom-4 duration-500 overflow-hidden ${
                    currentSignal.type === "CALL"
                      ? "bg-gradient-to-br from-[#2563eb]/20 via-[#2563eb]/10 to-transparent border-[#2563eb]/50"
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 opacity-30 blur-2xl ${
                      currentSignal.type === "CALL" ? "bg-[#2563eb]" : "bg-[#EF4444]"
                    }`}
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-8 h-8 rounded-full flex items-center justify-center ${
                            currentSignal.type === "CALL" ? "bg-[#2563eb]/20" : "bg-[#EF4444]/20"
                          }`}
                        >
                          <Volume2
                            className={`w-4 h-4 ${currentSignal.type === "CALL" ? "text-[#2563eb]" : "text-[#EF4444]"}`}
                          />
                        </div>
                      ...
                      <div
                        className={`px-3 py-1 rounded-full text-xs font-bold ${
                          currentSignal.type === "CALL" ? "bg-[#2563eb] text-white" : "bg-[#EF4444] text-white"
                        }`}
                      >
                        ...
                        <div className="flex items-center gap-2 justify-end">
                          ...
                          <p
                            className={`font-black text-2xl ${
                              currentSignal.type === "CALL" ? "text-[#2563eb]" : "text-[#EF4444]"
                            }`}
                          >
