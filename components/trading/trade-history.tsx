    ...
    <div className="bg-[#121826] border border-[#1f2933] rounded-xl p-4">
      ...
      <div className="grid grid-cols-4 gap-2 mb-4">
        ...
        <div className="bg-[#0B0F14] rounded-lg p-2 text-center">
          ...
          <div className="text-[#3b82f6] font-bold">{stats.wins}</div>
        </div>
        <div className="bg-[#0B0F14] rounded-lg p-2 text-center">
        ...
        <div className="bg-[#0B0F14] rounded-lg p-2 text-center">
          ...
          <div className={`font-bold ${winRate >= 50 ? "text-[#3b82f6]" : "text-[#EF4444]"}`}>
            {winRate.toFixed(0)}%
          </div>
        </div>
      </div>
      ...
      {/* P&L */}
      <div
        className={`p-3 rounded-lg mb-4 flex items-center justify-between ${stats.totalProfit >= 0 ? "bg-[#3b82f6]/10" : "bg-[#EF4444]/10"}`}
      >
        <span className="text-[#9CA3AF] text-sm">Lucro/Prejuízo Total</span>
        <span className={`font-mono font-bold ${stats.totalProfit >= 0 ? "text-[#3b82f6]" : "text-[#EF4444]"}`}>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div
                    className={`text-xs font-mono ${(trade.profit || 0) >= 0 ? "text-[#3b82f6]" : "text-[#EF4444]"}`}
                  >
