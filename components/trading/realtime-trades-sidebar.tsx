  ...
  return (
    <div className="px-4 pb-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <a href="/transactions" className="text-[#2563eb] text-xs hover:underline">
          Ver tudo
        </a>
      </div>
              ...
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center ${
                      isPending ? "bg-yellow-500/20" : isCall ? "bg-[#2563eb]/20" : "bg-[#EF4444]/20"
                    }`}
                  >
                    {isCall ? (
                      <TrendingUp className={`w-4 h-4 ${isPending ? "text-yellow-500" : "text-[#2563eb]"}`} />
                    ) : (
                ...
                <div className="text-right">
                  ...
                  {isPending ? (
                    ...
                    <div className={`text-xs font-bold ${isWin ? "text-[#2563eb]" : "text-[#EF4444]"}`}>
                      {isWin ? "+" : ""}
              ...
              {!isPending && (
                <div className="mt-2 pt-2 border-t border-white/5">
                  <div className="flex items-center justify-between text-[10px]">
                    ...
                    <span className={`font-bold uppercase ${isWin ? "text-[#2563eb]" : "text-[#EF4444]"}`}>
                      {isWin ? "✓ GANHOU" : "✗ PERDEU"}
                    </span>
                  </div>
                </div>
