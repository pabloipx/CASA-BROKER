  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 bg-[#121826] border border-[#1F2933] rounded-lg px-3 py-2 hover:border-[#2563eb]/50 transition-colors"
      >
        ...
        <div className="absolute top-full right-0 mt-2 w-72 bg-[#121826] border border-[#1F2933] rounded-xl shadow-xl z-50 overflow-hidden">
          ...
          <button
            ...
            className={`w-full flex items-center justify-between px-4 py-3 hover:bg-[#1F2933] transition-colors ${
              isDemo ? "bg-[#2563eb]/10 border-l-2 border-[#2563eb]" : ""
            }`}
          >
          ...
          >
            <div className="flex items-center gap-3">
              <div
                className={`w-10 h-10 rounded-full flex items-center justify-center ${
                  !isDemo ? "bg-[#2563eb]/20" : "bg-[#1F2933]"
                }`}
              >
                <Wallet className={`w-5 h-5 ${!isDemo ? "text-[#2563eb]" : "text-[#6B7280]"}`} />
              </div>
              <div className="text-left">
                <div className="flex items-center gap-2">
                  <span className="text-white font-medium">Conta real</span>
                  <span className="bg-[#2563eb]/20 text-[#2563eb] text-xs px-2 py-0.5 rounded">DINHEIRO</span>
                </div>
                <span className="text-[#9CA3AF] text-sm">Opere com saldo real</span>
              </div>
            </div>
            <span className={`font-bold ${!isDemo ? "text-[#2563eb]" : "text-white"}`}>
          ...
          <div className="border-t border-[#1F2933] p-3">
            <button className="w-full bg-[#2563eb] hover:bg-[#3b82f6] text-white font-bold py-2.5 rounded-lg transition-colors">
              Depositar
            </button>
          </div>
        </div>
