  ...
  return (
    <div className="bg-[#121826] border border-[#1f2933] rounded-xl p-4 flex flex-col gap-4">
      ...
      <div className="text-center">
        ...
        <div className="text-2xl font-mono font-bold text-[#2563eb]">{formatPrice(currentPrice)}</div>
        <div className="text-[#3b82f6] text-sm font-medium">Payout: {asset.payout}%</div>
      </div>
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-3 bg-[#0B0F14] border border-[#1f2933] rounded-lg text-white font-mono text-lg focus:outline-none focus:border-[#2563eb]"
          />
        </div>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                amount === amt
                  ...
                  : "bg-[#1f2933] text-[#9CA3AF] hover:bg-[#2563eb]/20 hover:text-white"
              }`}
            >
              ${amt}
            </button>
      ...
      <div className="bg-[#0B0F14] rounded-lg p-3 flex justify-between items-center">
        ...
        <span className="text-[#3b82f6] font-mono font-bold">+${potentialProfit.toFixed(2)}</span>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className="flex items-center justify-center gap-2 py-4 bg-[#3b82f6] hover:bg-[#2563eb] disabled:opacity-50 disabled:cursor-not-allowed rounded-xl text-white font-bold text-lg transition-colors"
        >
