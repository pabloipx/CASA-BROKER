                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <div className="text-[#2563eb] text-sm font-medium">Payout 95%</div>
                    </div>

                    <div className="text-right">
                      <div className="text-white font-mono font-semibold">{formatPrice(assetPrice, asset.symbol)}</div>
                      <div
                        className={`flex items-center justify-end gap-1 text-sm ${isUp ? "text-[#2563eb]" : "text-[#EF4444]"}`}
                      >
      ...
      >
        ...
        >
          ...
          <div className="flex-1 text-left">
            ...
            <div className="text-[#2563eb] font-semibold text-xs">Payout {payout}%</div>
          </div>
          <div className="text-right">
            <div className="text-white/60 text-xs">Pagamento</div>
            <div className="text-[#2563eb] font-bold text-sm">{formatBRL(potentialPayment)}</div>
          </div>
        </button>
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="relative">
                ...
                <input
                  ...
                  className="bg-transparent text-white font-bold text-xl w-24 text-center outline-none border-b-2 border-transparent focus:border-[#2563eb] transition-colors"
        ...
        <div className="space-y-2 pt-2">
          <button
            ...
            disabled={!canTrade}
            className={`w-full bg-[#2563eb] hover:bg-[#3b82f6] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-4 text-lg rounded-lg transition-all flex items-center justify-center gap-2 ${
          ...
          <div className="text-center">
            ...
            <div className="text-[#2563eb] font-bold text-lg">{formatBRL(potentialPayment)}</div>
          </div>
