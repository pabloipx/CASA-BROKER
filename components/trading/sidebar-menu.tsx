      ...
      >
        ...
        <div className="p-5 pb-0 flex-shrink-0">
          ...
          <div className="relative rounded-2xl overflow-hidden mb-5">
            <div className="absolute inset-0 bg-gradient-to-br from-[#2563eb]/20 via-[#172554]/30 to-transparent" />
            <div className="relative p-4 border border-[#2563eb]/20 rounded-2xl">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] flex items-center justify-center shadow-lg shadow-blue-500/20">
          ...
          <div className="grid grid-cols-2 gap-2 mb-4">
            <button
              ...
              className="flex items-center justify-center gap-2 py-2.5 rounded-xl bg-[#2563eb] hover:bg-[#1d4ed8] text-white text-xs font-semibold transition shadow-lg shadow-blue-500/20"
            >
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-3">
          ...
          {mainMenuItems.map((item) => (
            ...
            >
              <div className="w-8 h-8 rounded-lg bg-white/[0.04] group-hover:bg-[#2563eb]/10 flex items-center justify-center transition">
                <item.icon className="w-4 h-4 text-white/40 group-hover:text-[#3b82f6] transition" />
              </div>
