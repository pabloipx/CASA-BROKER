  ...
  return (
    <div className="min-h-screen pb-24" style={{ backgroundColor: "#0B0F14" }}>
      ...
      <div className="px-4 pt-6">
        <div
          className="relative overflow-hidden rounded-2xl border border-[#2563eb]/20 p-6"
          style={{ background: "linear-gradient(135deg, #2563eb22 0%, #121826 60%)" }}
        >
          <div className="flex items-center gap-4">
            <div className="relative">
              <div className="w-20 h-20 rounded-full flex items-center justify-center border-2 border-[#2563eb]/40 bg-[#0B0F14] overflow-hidden">
                {profile?.avatar_url ? (
                  <img
                  ...
                  <span className="text-2xl font-bold text-[#2563eb]">{initials}</span>
                )}
              </div>
              {profile?.is_verified && (
                <span className="absolute -bottom-1 -right-1 rounded-full bg-[#0B0F14] p-0.5">
                  <BadgeCheck className="w-6 h-6 text-[#2563eb]" fill="#2563eb" stroke="#0B0F14" />
                </span>
              )}
            </div>
      ...
      <div className="px-4 pt-6">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <HandCoins className="w-4 h-4 text-[#2563eb]" />
            <h3 className="text-base font-semibold text-white">Histórico de saques</h3>
          </div>
          <Link href="/transactions" className="flex items-center gap-1 text-xs font-medium text-[#60a5fa] active:opacity-70">
            Ver tudo
        ...
        {recentWithdrawals.length === 0 ? (
          ...
          >
            ...
            <Link href="/withdraw" className="mt-3 inline-block text-sm font-medium text-[#60a5fa] active:opacity-70">
              Solicitar saque
            </Link>
          </div>
        ) : (
            ...
            {recentWithdrawals.map((withdrawal) => {
              ...
              return (
                <div
                  ...
                  style={{ backgroundColor: "#121826" }}
                >
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 bg-[#2563eb]/15">
                    <HandCoins className="w-5 h-5 text-[#2563eb]" />
                  </div>
      ...
      <div className="px-4 pt-6 space-y-3">
        ...
        <Link href="/afiliados" className="block">
          <div
            className="p-5 rounded-2xl border border-[#2563eb]/30 active:scale-[0.99] transition-transform"
            style={{ background: "linear-gradient(135deg, #2563eb18 0%, #121826 100%)" }}
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
