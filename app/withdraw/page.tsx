    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-[#0B0F14]">
        <div className="animate-in fade-in zoom-in duration-300 flex flex-col items-center">
          <div className="w-16 h-16 rounded-full bg-[#2563eb] flex items-center justify-center mb-4 shadow-lg shadow-[#2563eb]/30">
            <Check className="w-8 h-8 text-white" strokeWidth={3} />
          </div>
          <p className="text-xl font-semibold text-[#3b82f6] text-center">Saque solicitado com sucesso!</p>
  ...
  return (
    <div className="min-h-screen bg-[#0B0F14]">
      ...
      <div className="px-4 py-6 space-y-6 max-w-xl mx-auto">
        {isKycApproved ? (
          <div className="p-4 rounded-xl bg-[#2563eb]/10 border border-[#2563eb]/30">
            <div className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-[#2563eb] flex-shrink-0 mt-0.5" />
              <div className="flex-1">
                <p className="text-sm font-medium text-[#2563eb]">Conta Verificada</p>
            ...
            <button
              ...
              className={`p-4 rounded-xl border-2 transition-all ${
                withdrawMethod === "pix"
                  ...
                  : "border-[#1F2933] bg-[#121826] hover:border-[#2563eb]/50"
              }`}
            >
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-center">
                  <p className={`font-semibold ${withdrawMethod === "pix" ? "text-[#2563eb]" : "text-white"}`}>PIX</p>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="0,00"
              disabled={needsKyc}
              className="w-full py-4 pl-12 pr-4 rounded-xl text-white text-lg font-semibold bg-[#121826] border border-[#1F2933] focus:border-[#2563eb] outline-none transition-colors disabled:opacity-50"
            />
          </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          {QUICK_AMOUNTS.map((value) => (
            <button
              ...
              className="py-3 px-2 rounded-xl text-sm font-medium text-white bg-[#121826] border border-[#1F2933] hover:border-[#2563eb] disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
            >
          ...
          <>
                  ...
                  <button
                    ...
                    className={`py-2.5 px-2 rounded-xl text-xs font-medium transition-colors disabled:opacity-50 ${
                      pixKeyType === type.value
                        ...
                        : "bg-[#121826] text-[#9CA3AF] border border-[#1F2933] hover:border-[#2563eb]"
                    }`}
                  >
                    {type.label}
                  </button>
            ...
            <div>
              ...
              <input
                ...
                className="w-full py-4 px-4 rounded-xl text-white bg-[#121826] border border-[#1F2933] focus:border-[#2563eb] outline-none transition-colors disabled:opacity-50"
              />
            </div>
          </>
        ) : (
          <>
            ...
            <div>
              ...
              <input
                ...
                disabled={needsKyc}
                placeholder="0x..."
                className="w-full py-4 px-4 rounded-xl text-white font-mono bg-[#121826] border border-[#1F2933] focus:border-[#2563eb] outline-none transition-colors disabled:opacity-50"
              />
