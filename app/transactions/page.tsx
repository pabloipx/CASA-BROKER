                    ...
                    return (
                      <div key={trade.id} className="rounded-xl overflow-hidden" style={{ backgroundColor: "#1A2332" }}>
                        ...
                        <div className="p-4 flex items-center gap-3">
                          ...
                          <div
                            className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                              isCall ? "bg-[#2563eb]/20" : "bg-[#EF4444]/20"
                            }`}
                          >
                            {isCall ? (
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-3 text-xs text-[#6B7280]">
                              <span className={`font-medium ${isCall ? "text-[#2563eb]" : "text-[#EF4444]"}`}>
                                {isCall ? "COMPRA" : "VENDA"}
                              </span>
                          ...
                          <div className="text-right">
                            <div className="flex items-center justify-end gap-2 mb-1">
                              {isPending ? (
                                ...
                                <span className="px-2 py-1 text-xs font-semibold bg-[#2563eb]/20 text-[#2563eb] rounded-lg">
                                  VITÓRIA
                                </span>
                              ) : (
                            ...
                            {trade.profit !== null && trade.profit !== 0 && (
                              <p
                                className={`text-xs font-semibold mt-1 ${trade.profit >= 0 ? "text-[#2563eb]" : "text-[#EF4444]"}`}
                              >
                        ...
                        <div className="px-4 py-2 bg-[#0F1620] flex items-center justify-between text-xs">
                          ...
                          <span className="text-[#6B7280]">
                            Payout: <span className="text-[#2563eb]">{trade.payout_percentage}%</span>
                          </span>
                        </div>
                      </div>
                    )
