        ...
        <div className="flex items-center gap-2 bg-[#1a1a1f] rounded-xl p-1 border border-white/10">
          <button
            ...
            className={`flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-colors ${
              filter === "all" ? "bg-blue-600 text-white" : "text-white/60 hover:text-white"
            }`}
          >
            Todos
          </button>
      ...
      <div className="px-4 pb-8">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <Link href="/trade" className="mt-4 inline-block text-blue-500 hover:underline">
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${
                          trade.direction === "CALL" ? "bg-blue-500/20" : "bg-red-500/20"
                        }`}
                      >
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="text-right">
                      ...
                      <p className={`font-medium ${(trade.profit || 0) >= 0 ? "text-blue-500" : "text-red-500"}`}>
