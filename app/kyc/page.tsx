  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="p-4 max-w-lg mx-auto space-y-6">
        {/* Success Message */}
        {success && (
          <Card className="border-green-500 bg-blue-500/10">
            <CardContent className="pt-6">
              <div className="text-center">
                <CheckCircle className="h-12 w-12 text-blue-500 mx-auto mb-3" />
                <p className="text-blue-500 font-semibold">Documentos enviados com sucesso!</p>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-lg flex items-center gap-2">
              {kycStatus === "pending" && <Clock className="h-5 w-5 text-blue-500" />}
          ...
          <CardContent>
            {kycStatus === "pending" && (
              <div className="text-center py-4">
                ...
                <p className="text-blue-500 font-semibold text-lg">Em Análise</p>
        ...
        {(kycStatus === "unverified" || kycStatus === "rejected") && !success && (
          <>
            ...
            <div className="flex justify-center gap-2 pt-2">
              <div className={`h-2 w-16 rounded-full ${documentFrontPath ? "bg-blue-500" : "bg-muted"}`} />
              <div className={`h-2 w-16 rounded-full ${documentBackPath ? "bg-blue-500" : "bg-muted"}`} />
              <div className={`h-2 w-16 rounded-full ${selfiePath ? "bg-blue-500" : "bg-muted"}`} />
            </div>
