...
export default function AffiliatePage() {
          ...
          {loadError ? (
            <>
              ...
              <button
                ...
                className="px-6 py-3 rounded-xl bg-[#2563eb] text-white font-medium"
              >
                Tentar novamente
              </button>
            </>
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#0a0e17" }}>
      ...
      <div className="p-4">
        <div
          className="relative overflow-hidden p-5 rounded-2xl border border-[#2563eb]/25"
          style={{ background: "linear-gradient(135deg, #2563eb1f 0%, #0a0e17 60%)" }}
        >
          {/* Malha tecnologica */}
          <div
          ...
          />
          {/* Brilho */}
          <div className="absolute -top-10 -right-10 h-32 w-32 rounded-full bg-[#2563eb]/25 blur-3xl pointer-events-none" />
        ...
        <div className="mt-4 p-4 rounded-xl bg-[#121826] border border-[#1F2933]">
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <button
              onClick={copyCode}
              className="p-3 rounded-lg bg-[#2563eb] hover:bg-[#2563eb]/80 transition-colors flex-shrink-0"
            >
      ...
      <div className="p-4">
            ...
            <div className="p-4 rounded-xl bg-[#121826] border border-[#1F2933]">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between py-2 border-b border-[#1F2933]">
                  ...
                  <span className="text-[#2563eb] font-bold">{affiliate.commission_rate + "%"}</span>
                </div>
        ...
        {activeTab === "withdraw" && (
          <div className="space-y-4">
            {withdrawSuccess && (
              <div className="p-4 rounded-xl bg-[#2563eb]/20 border border-[#2563eb]/30">
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-[#2563eb]" />
                  <p className="text-[#2563eb] font-medium">Saque solicitado com sucesso!</p>
                </div>
              </div>
            )}
            ...
            <div className="p-4 rounded-xl bg-[#121826] border border-[#1F2933]">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="0,00"
                  className="w-full p-4 pl-12 rounded-xl bg-[#0a0e17] border border-[#1F2933] text-white text-lg font-bold focus:border-[#2563eb] outline-none"
                />
              </div>
            ...
            <div className="p-4 rounded-xl bg-[#121826] border border-[#1F2933]">
              ...
              <input
                ...
                className="w-full p-4 rounded-xl bg-[#0a0e17] border border-[#1F2933] text-white focus:border-[#2563eb] outline-none"
              />
            </div>
      ...
      {processingAnim && (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="relative flex h-24 w-24 items-center justify-center">
            {/* aneis pulsantes */}
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#2563eb]/20" />
            <span className="absolute inline-flex h-16 w-16 animate-ping rounded-full bg-[#2563eb]/30 [animation-delay:200ms]" />
            {/* anel giratorio */}
            <span className="absolute h-24 w-24 rounded-full border-4 border-[#2563eb]/20 border-t-[#2563eb] animate-spin" />
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#2563eb]/15 ring-1 ring-[#2563eb]/40">
      ...
      {confirmation && (
        ...
        >
          ...
          >
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#2563eb]/15 ring-1 ring-[#2563eb]/30">
            ...
            <button
              type="button"
              onClick={() => setConfirmation(null)}
              className="mt-5 w-full rounded-xl bg-[#2563eb] py-3 font-semibold text-white transition-colors hover:bg-[#1d4ed8]"
            >
              Entendi
            </button>
          </div>
