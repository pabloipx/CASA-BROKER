...
export const metadata = {
  title: "CASA BROKER - Plataforma de Trading Profissional",
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#030712]">
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-[#1e3a8a] via-[#2563eb] to-[#1e3a8a] text-center py-3 px-4">
      ...
      <section className="relative min-h-[85vh] flex flex-col items-center justify-end overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {/* Blue tint overlay */}
          <div className="absolute inset-0 bg-[#0e1a33]/30 mix-blend-multiply" />
          {/* Malha tecnologica */}
          <div
          ...
          <div className="absolute bottom-1/4 left-1/2 -translate-x-1/2 h-72 w-[36rem] max-w-[90%] rounded-full bg-[#2563eb]/20 blur-[120px]" />
        </div>
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto text-center px-6 pb-12 lg:pb-20">
          ...
          <Button
            asChild
            size="lg"
            className="group relative bg-[#2563eb] hover:bg-[#3b82f6] text-white text-base md:text-lg lg:text-xl px-10 lg:px-14 py-7 lg:py-8 rounded-xl shadow-[0_8px_40px_-8px_rgba(37, 99, 235,0.7)] hover:shadow-[0_8px_50px_-6px_rgba(59, 130, 246,0.9)] transition-all duration-300 font-bold uppercase tracking-wide"
          >
      ...
      {/* Stats Bar */}
      <section className="relative bg-[#0e1a33] border-y border-[#1e3a8a]/30 py-10 px-4 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {[
            ...
            <div
              key={stat.label}
              className="group relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5 text-center transition-all duration-300 hover:border-[#2563eb]/40 hover:bg-[#2563eb]/[0.04]"
            >
              <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-[#2563eb]/10 ring-1 ring-[#2563eb]/20 transition-colors group-hover:bg-[#2563eb]/20">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 text-balance">
              Mais de <span className="text-[#2563eb]">300 ativos</span> para você escolher
            </h2>
          ...
          <div className="relative overflow-hidden rounded-2xl p-8 border border-[#2563eb]/20 bg-gradient-to-b from-[#0e1a33] to-[#0e1a33]/40">
            {/* Brilho de destaque */}
            <div className="absolute -top-16 left-1/2 -translate-x-1/2 h-40 w-72 rounded-full bg-[#2563eb]/20 blur-[90px]" />

            <div className="relative">
              <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#2563eb]/10 ring-1 ring-[#2563eb]/30">
                <Wallet className="h-7 w-7 text-[#3b82f6]" />
              </div>
              ...
              <div className="text-center">
                <Button
                  asChild
                  size="lg"
                  className="group bg-[#2563eb] hover:bg-[#3b82f6] text-white font-bold uppercase tracking-wide px-8 py-6 rounded-xl shadow-[0_8px_40px_-8px_rgba(37, 99, 235,0.7)] hover:shadow-[0_8px_50px_-6px_rgba(59, 130, 246,0.9)] transition-all duration-300"
                >
                  <Link href="/auth/sign-up" className="flex items-center gap-2">
                    ENTRE NA CASA BROKER AGORA
      ...
      {/* About Section */}
      <section id="about" className="py-16 px-4 bg-[#0e1a33]/50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-6 text-center text-balance">
            O que e a <span className="text-[#2563eb]">CASA BROKER</span>?
          </h2>

          <div className="max-w-3xl mx-auto space-y-4 text-white/60 leading-relaxed text-sm text-center">
            <p>
              A CASA BROKER e uma corretora digital moderna voltada para negociacoes rapidas e seguras no mercado
              financeiro global. Focada em eficiencia, acessibilidade e inovacao.
            </p>
            <p>
              Com uma estrutura tecnologica avancada, a CASA BROKER oferece um ambiente estavel e confiavel para
      ...
      <section id="how-it-works" className="py-16 px-4 bg-[#030712]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-4 text-center text-balance">
            Como funciona a <span className="text-[#2563eb]">CASA BROKER</span>?
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={item.title} className="bg-white/[0.03] rounded-xl p-5 text-center border border-white/[0.05] hover:border-[#2563eb]/30 transition-all">
                <div className="w-12 h-12 rounded-full mx-auto mb-3 flex items-center justify-center bg-[#2563eb]/15">
      ...
      {/* Security Section */}
      <section id="security" className="py-16 px-4 bg-[#0e1a33]/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="w-14 h-14 rounded-full mx-auto mb-4 flex items-center justify-center bg-[#2563eb]/15">
              <Shield className="w-7 h-7 text-[#2563eb]" />
            </div>
            <h2 className="text-3xl font-bold text-white mb-4 text-balance">
              Seguranca em <span className="text-[#2563eb]">primeiro lugar</span>
            </h2>
            <p className="text-white/50 max-w-xl mx-auto text-sm">
              Na CASA BROKER, a seguranca dos usuarios e prioridade maxima.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            {[
              ...
              <div key={item.title} className="bg-white/[0.03] rounded-xl p-5 border border-white/[0.05] hover:border-[#2563eb]/30 transition-all">
                <item.icon className="w-7 h-7 mb-3 text-[#2563eb]" />
                <h3 className="text-white font-semibold text-sm mb-1">{item.title}</h3>
                <p className="text-white/40 text-xs leading-relaxed">{item.desc}</p>
              </div>
            ))}
          ...
          <div className="rounded-xl p-5 border border-white/[0.06] bg-[#030712]/60">
            <div className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 mt-0.5 flex-shrink-0 text-[#2563eb]" />
              <div>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/80 mb-8 text-sm">
            Junte-se a milhares de traders que ja estao aproveitando as vantagens da CASA BROKER.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-white text-[#1e3a8a] hover:bg-white/90 font-bold px-8">
